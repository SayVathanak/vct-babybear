            ...
            <div className="px-6 md:px-16 lg:px-32 py-16 flex flex-col md:flex-row justify-between">
                <form onSubmit={onSubmitHandler} className="w-full">
                    <p className="text-2xl md:text-3xl text-gray-500">
                        Add Delivery <span className="font-semibold text-black">Address</span>
                    </p>
                    ...
                    <button type="submit" className="max-w-sm w-full mt-6 bg-black text-white py-3 hover:bg-green-500 transition duration-300 uppercase">
                        Save address
                    </button>
                </form>
                <Image
