...
const AllProducts = () => {
    const { products, router } = useAppContext(); // Get router from context
    const searchParams = useSearchParams(); // Get reactive search params
    ...
    // This effect now correctly syncs the state with the URL search parameters
    useEffect(() => {
                    ...
                    <div className="relative flex flex-col lg:flex-row gap-8">
                        ...
                        >
                            ...
                            <div className="flex-grow overflow-y-auto p-4">
                                <ProductFilter
                                    router={router} // Pass router to the filter component
...
// Wrap the component in a Suspense boundary as recommended for useSearchParams
