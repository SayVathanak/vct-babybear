...
const CartPopup = () => {
  ...
  return (
    <div className="cart-popup fixed bottom-0 bg-white shadow-lg z-50 border-t-6 border-dotted animate-slideUp rounded-t-md w-full max-w-md mx-auto left-0 right-0">
